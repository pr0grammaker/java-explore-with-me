...
public class EventJsonTest {
    ...
    void testSerializeEventFullDto() throws Exception {
        ...
        assertThat(json.write(dto)).isEqualToJson(
                "{\"id\":1,\"title\":\"Новое событие\",\"annotation\":\"Аннотация\",\"description\":\"Описание\",\"category\":{\"id\":10,\"name\":\"Концерт\"},\"initiator\":{\"id\":5,\"name\":\"Иван Иванов\"},\"location\":{\"lat\":51.1694,\"lon\":71.4491},\"eventDate\":\"2024-12-31 15:10:05\",\"createdOn\":\"2024-12-01 12:00:00\",\"publishedOn\":\"2024-12-02 12:00:00\",\"confirmedRequests\":5,\"views\":100,\"paid\":true,\"participantLimit\":10,\"requestModeration\":true,\"state\":\"PUBLISHED\"}"
        );
    }
