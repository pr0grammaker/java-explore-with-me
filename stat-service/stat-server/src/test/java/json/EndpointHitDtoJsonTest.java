...
public class EndpointHitDtoJsonTest {
    ...
    void serializeEndpointHitDtoTest() throws IOException {
        ...
        String expectedJson = "{\"app\":\"stats-service\",\"uri\":\"/items/42\",\"ip\":\"192.168.0.1\",\"timestamp\":\"2026-07-26 12:30:00\"}";
    ...
    void deserializeEndpointHitDtoTest() throws Exception {
        String content = "{\"app\":\"stats-service\",\"uri\":\"/items/42\",\"ip\":\"192.168.0.1\",\"timestamp\":\"2026-07-26 12:30:00\"}";
